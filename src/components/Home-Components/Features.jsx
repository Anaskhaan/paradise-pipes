        ...
        {features.map((feature, index) => (
          <div key={index} className="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center text-center">
            ...
            <div className="w-16 h-16 bg-gray-200 rounded-md mb-4 flex items-center justify-center">
              <img src={feature.image} alt={feature.title} className="w-full h-full object-contain rounded-md" />
            </div>

            {/* Feature Title */}
            <h2 className="text-black font-semibold text-lg">{feature.title}</h2>
